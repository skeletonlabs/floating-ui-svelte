...
>
	...
	>
		<svg class="fill-white w-32" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
			<title>Svelte</title>
			<path
	...
	<nav class="p-8 pb-56">
		<ul>
			{#each navList as link}
				<li>
					<a href={link.href} class="block hover:bg-surface-500/10 p-4 rounded-xl text-lg">
						<span>(i)</span>
